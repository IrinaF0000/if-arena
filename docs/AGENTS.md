...
Docs should clarify the project and reduce repeated agent context loading.

## Rules

- Keep documents focused and short where possible.
- Do not duplicate large rule blocks across files.
