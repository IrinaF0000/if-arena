...
The project implements modular gameplay runtime design: a domain-neutral ECS-style Core, feature-owned battle mechanics, deterministic scenario execution, JSON trace output, browser replay tooling, and CI-backed regression checks.
